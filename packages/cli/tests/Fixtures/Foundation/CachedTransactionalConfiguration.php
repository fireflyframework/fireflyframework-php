 ...
 * not the Laravel container). #[Order(0)] sorts strictly before DataAutoConfiguration's #[Order(1000)], so its
 * empty default steps aside. On the cached boot this #[Configuration] is discovered from the compiled
 ...
 * base_path(); the skeleton's committed copy uses base_path('bootstrap/cache/firefly/transactional.php'). Verbatim
 * from the T3 App\CachedTransactionalConfiguration.
 */
#[Configuration]
