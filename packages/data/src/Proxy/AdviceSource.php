 ...
 * Container::getAll(); firefly:cache lists them explicitly.
 *
 ...
 * the container when the bean is wrapped; if that bean is absent (the capability is switched off), the
 * proxy runs a PassThroughInterceptor in its place.
 */
