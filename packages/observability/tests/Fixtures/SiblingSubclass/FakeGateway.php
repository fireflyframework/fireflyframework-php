 ...
 * class whose author greps it for a metric attribute and finds none, with a remedy ("add #[Service]") that is
 * the opposite of what they want. Its rows are dropped in silence instead — the annotated ancestor is where a
 * refusal would belong, and the ancestor is already answered for by the bean beside it.
 */
