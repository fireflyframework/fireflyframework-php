 ...
 * after SecurityWiringPass's 200: the server's refusals assume the core's guards already ran). Both this and
 * SecurityOAuth2ServerServiceProvider are in extra.laravel.providers.
 */
final class SecurityOAuth2ServerWiringProvider extends FireflyServiceProvider
{
    ...
    {
        return [new OAuth2ServerWiringPass];
    }
}
