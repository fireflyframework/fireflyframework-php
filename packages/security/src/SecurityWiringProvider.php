 ...
 * the SessionSecurityBootstrap (order 90, the global session middleware) and the SecurityWiringPass (order 200).
...
final class SecurityWiringProvider extends FireflyServiceProvider
{
    ...
    {
        return [new SessionSecurityBootstrap, new SecurityWiringPass];
    }
}
